...
<div class="row">
    <div class="col-lg-12 ">
      ...
      <form ref="form"   v-on:submit.prevent="formulario()">
        <div class="row">
          <div class="col-md-12 row">
            <input type="hidden" v-model="input_MantenimientoActividad_id">
...
export default {
 ...
 //   Select2
  ...
  methods: {
    ...
    data_foraneo(){
        axios.get(`${this.$url}/Api/MantenimientoActividad/create`).then(response => {
    ...
    formulario(){
      ...
      const data = {
        id: this.input_MantenimientoActividad_id,
        id :this.input_id,
      ...
      if(this.editar_dato == true){
        axios.put(`${this.$url}/Api/MantenimientoActividad/${this.input_MantenimientoActividad_id}`, data)
        .then(response => {
        ...
        axios.post(`${this.$url}/Api/MantenimientoActividad`, data).then(response => {
            const datos = response.data;
            if(response.data.errors){
              this.$toastr.warning("Verifique los datos", "Verifique los datos");
              this.validacion=response.data.errors;
    ...
    show_registro(data_id){//show_registro
      ...
      axios.get(`${this.$url}/Api/MantenimientoActividad/${data_id}`).then(response => {
            ...
            if(!response.data){
              ...
              this.input_MantenimientoActividad_id = data.id
