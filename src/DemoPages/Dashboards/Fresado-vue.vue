...
export default {
  ...
  data() {
    ...
    return {
      ...
      { key: 'unidad_funcional_id.nombre',label:"UF", sortable:true,class:'one-lineas'},
      { key: 'pr',label:"PR", sortable:true,class:'one-lineas'},
      { key: 'pr_inicial',label:"PR In", sortable:true,class:'one-lineas'},
      { key: 'pr_final',label:"PR Fi", sortable:true,class:'one-lineas'},
      ...
      { key: 'volumen',label:"Volumen", sortable:true,class:'one-lineas'},
