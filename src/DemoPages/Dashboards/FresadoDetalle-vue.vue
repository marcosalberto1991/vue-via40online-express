<template>
  <div class="">
                        ...
                        <tbody>
                            <tr v-for="(data,index) in consulta_datos" v-bind:key="data.id">
                                ...
                                <td style="overflow-x: auto">
                                    ...
                                    <span @click="showModal(imagen.file)" >
                                        <img :src="'data:imagen/jpg;base64,'+imagen.file" height="100px" />
    ...
    <b-modal id="moda-eliminar" ref="my-modal" size="lg" hide-footer>
    ...
    <b-modal ref="my-modal-imagen"  size="xl" title="Registro Fotografico">
       <div class="d-block text-center">
      <button class="btn btn-info" @click="descarga_img()" >
                                    Descargar Imágene
                                    </button>
                                    <br>
                                    <br>
        ...
        <spam>
        <img :src="'data:imagen/jpg;base64,'+modal_imagen+''" class="img-fluid" />
        </spam>
  ...
  methods: {
      descarga_img(){
          var a = document.createElement("a"); //Create <a>
            a.href = "data:image/png;base64," + this.modal_imagen; //Image Base64 Goes here
            a.download = "Image.png"; //File name Here
            a.click(); //Downloaded file
      },
    showModal(imagen) {
        this.modal_imagen=imagen;
        this.$refs['my-modal-imagen'].show()
    },
    consulta(page = 1) {
